...
Let's prove the following two expressions are equivalent. We show they have
the same normal form, a Denotational Normal Form (DNF), a semantic normal form that is not yet aware of memory layout or architectural components: vector registers, DMAs, etc.
